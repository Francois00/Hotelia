  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-5">
        <h2 className="text-lg font-semibold text-gray-900 text-center">Abrir nuevo turno</h2>
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              ...
              <label key={opt.value} className="flex items-center gap-3 cursor-pointer p-3 border rounded-xl hover:bg-gray-50 transition-colors">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">💡 Cuenta el efectivo físico que hay en caja ahora</p>
        </div>
