    ...
    <div className="relative">
      ...
      {abierto && (
        <>
          ...
          <div className="absolute right-0 mt-1 w-72 bg-white rounded-xl shadow-xl border border-gray-200 z-20 py-1.5">
            {locales.map(l => {
                ...
                >
                  <span className="flex items-center gap-2">
                    ...
                    <span>
                      ...
                      <span className="block text-xs text-gray-400">{l.rol}</span>
                    </span>
                  </span>
